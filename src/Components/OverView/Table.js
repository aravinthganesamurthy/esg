                    ...
                    <Table>
                        ...
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell rowSpan={2}>ESG Composite Score (Prev. Year)</TableCell>
                        ...
                        <TableBody>
                            {visibleRows.map((row, index) => (
                                <TableRow key={index}>
                                    ...
                                    <TableCell>{row["ESG Composite Score (Prev. Year)"]}</TableCell>

                                    <TableCell>{row["Environment"]["Carbon Emissions (Tonnes)"]}</TableCell>
                                    <TableCell>{row["Environment"]["Energy Usage (GW)"]}</TableCell>
                                    <TableCell>{row["Environment"]["Energy Efficiency"]}</TableCell>
                                    <TableCell>{row["Environment"]["Water Usage (Tonnes)"]}</TableCell>
                                    <TableCell>{row["Environment"]["Water Conservation"]}</TableCell>
                                    <TableCell>{row["Environment"]["Pollution Index (Out of 1)"]}</TableCell>

                                    <TableCell>{row["Social"]["Diversity"]}</TableCell>
                                    <TableCell>{row["Social"]["Data Privacy"]}</TableCell>
                                    <TableCell>{row["Social"]["Supply Chain Responsibility"]}</TableCell>
                                    <TableCell>{row["Social"]["Community Engagement"]}</TableCell>


                                    <TableCell>{row["Governance"]["Board Diversity"]}</TableCell>
                                    <TableCell>{row["Governance"]["Perfomance Based Compenation"]}</TableCell>
                                    <TableCell>{row["Governance"]["Transparency Score"]}</TableCell>
                                    <TableCell>{row["Governance"]["Regulatory Compliance"]}</TableCell>
